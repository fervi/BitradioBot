The BitradioBot project is a bot that is used to make money using the Bitrad.io cryptocurrency. His task is to recognize what is happening on the screen and react to it.
